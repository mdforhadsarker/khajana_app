          ...
          <div className="px-6 py-6 lg:px-8">
            ...
            <form className="space-y-6" action="#">
              ...
              <div className="flex justify-between">
                <button
                  type="Reset"
                  className="space-x-4 inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-black whitespace-no-wrap bg-slate-200 border-slate-200 rounded-md shadow-sm focus:outline-none"
                >
                  Reset
                </button>
                <button
